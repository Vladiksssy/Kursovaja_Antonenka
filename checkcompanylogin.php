	...
	if($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			if($row['active'] == '2') {
				...
				$_SESSION['companyLoginError'] = "Your Account Is Rejected. Please Contact Admin For More Info: vladislava2003love@gmail.com";
				header("Location: login-company.php");
				exit();
				...
				$_SESSION['companyLoginError'] = "Your Account Is Deactivated. Contact Admin For Reactivation: vladislava2003love@gmail.com";
				header("Location: login-company.php");
				exit();
			}
		}
