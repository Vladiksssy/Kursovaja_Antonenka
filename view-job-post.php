                        ...
                        <div>
                            <p>
                                <span class="margin-right-10"><i
                                            class="fa fa-location-arrow text-green"></i> <?php echo $row['city']; ?></span>
                                <span><i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></span>
                            </p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        if (isset($_SESSION["id_user"]) && empty($_SESSION['companyLogged'])) {
                                            echo "<a href='apply.php?id=" . $row['id_jobpost'] . "' class='fa fa-address-card-o'>Apply</a>";
                                        }
                                        ?>
                                    </div>
...
?>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023-2024 <a href="jonsnow.netai.net">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
