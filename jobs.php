                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="" class="citySearch" data-target="Minsk"><i class="fa fa-circle-o text-yellow"></i> Minsk</a></li>
                      <li><a href="" class="citySearch" data-target="Moskva"><i class="fa fa-circle-o text-yellow"></i> Moscow</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
